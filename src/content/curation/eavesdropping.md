...
![CGW_Eavesdropping documentation_hiRes_37.jpg](../_assets/curation/eavesdropping/CGW_Eavesdropping_documentation_hiRes_37.jpg)

*2018, 2019*

*Ian Potter Museum of Art + City Gallery, Wellington*

This is an anachronism. [Eavesdropping](https://eavesdropping.exposed/) was curated by James Parker and Joel Stern and originally shown at the Ian Potter Museum of Art, before before redeveloped at a larger scale for City Gallery, Wellington, the following year. Though the exhibition did explore questions of machine listening, via two works by Sean Dockray and a public program entitled *Silicon Ear*, this was not the whole story. But it is where the seeds of this collective project were first sown. 

There is [documentation of the project here](https://eavesdropping.exposed/documentation).

And a [publication](https://eavesdropping.exposed/a-reader) featuring essays by all of the artists, along with beautiful design by Public Office.
